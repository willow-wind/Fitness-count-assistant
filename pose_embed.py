...
class FullBodyPoseEmbedder(object):
    ...
    def __call__(self, landmarks):
        ...
        参数:landmarks - 包含形状为(N, 3)的三维地标的NumPy数组
        结果:具有形状 (M, 3) 的姿势embedding的 Numpy 数组，其中“M”是函数_get_pose_distance_embedding中定义的成对距离的数量。
        """
    ...
    def _get_pose_distance_embedding(self, landmarks):
        ...
        使用几个成对的 3D 距离来形成姿势embedding。 所有距离都包括带符号的 X 和 Y 分量。
